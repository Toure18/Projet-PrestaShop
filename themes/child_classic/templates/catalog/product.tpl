 ...
 *}
 ...
 {block name='content'}
   ...
   <section id="main">
     ...
     <div class="row product-container js-product-container d-flex flex-row-reverse">
           ...
           {block name='page_header_container'}
             {block name='page_header'}
               <h1 class="h1">{block name='page_title'}{$product.name}{/block}</h1>
                <p class="text-muted"> Reférence : {block name='product_reference'}{$product.reference}{/block}</p>
             {/block}
           {/block}
